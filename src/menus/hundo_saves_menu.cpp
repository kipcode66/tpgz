    ...
    if (button_is_down(Controller::A) && !button_is_held(Controller::A)) {
        switch (cursor.y) {
            ...
            case HND_ORDON_GATE_CLIP_INDEX: {
                loadFile("tpgzw/save_files/hundo/ordon_gate_clip.bin");
                default_load();
            ...
            case HND_GOATS_2_INDEX: {
                loadFile("tpgzw/save_files/hundo/goats_2.bin");
                default_load();
            ...
            case HND_FARON_TWILIGHT_INDEX: {
                loadFile("tpgzw/save_files/hundo/faron_twilight.bin");
                default_load();
                break;
            }

            case HND_EMS_INDEX: {
                loadFile("tpgzw/save_files/hundo/ems.bin");
                default_load();
                break;
            }
            case HND_MIST_INDEX: {
                loadFile("tpgzw/save_files/hundo/purple_mist.bin");
                default_load();
                angle = 40758;
            ...
            case HND_FRST_BIT_INDEX: {
                loadFile("tpgzw/save_files/hundo/forest_bit.bin");
                default_load();
                break;
            }

            case HND_FRST_2_INDEX: {
                loadFile("tpgzw/save_files/hundo/forest_2.bin");
                default_load();
                break;
            }

            case HND_OOKLESS_INDEX: {
                loadFile("tpgzw/save_files/hundo/ookless.bin");
                default_load();
                break;
            }

            case HND_ELDIN_TWILIGHT_INDEX: {
                loadFile("tpgzw/save_files/hundo/eldin_twilight.bin");
                default_load();
                break;
            }

            case HND_LANAYRU_GATE_CLIP_INDEX: {
                loadFile("tpgzw/save_files/hundo/lanayru_gate_clip.bin");
                default_load();
            ...
            case HND_PILLAR_CLIP_INDEX: {
                loadFile("tpgzw/save_files/hundo/pillar_clip.bin");
                default_load();
                break;
            }
            case HND_LAKEBED_1_INDEX: {
                loadFile("tpgzw/save_files/hundo/lakebed_1.bin");
                default_load();
                break;
            }
            case HND_TOAD_INDEX: {
                loadFile("tpgzw/save_files/hundo/deku_toad.bin");
                default_load();
                break;
            }
            case HND_KARG_INDEX: {
                loadFile("tpgzw/save_files/hundo/karg.bin");
                default_load();
                practice_file.inject_options_during_load = karg_oob;
                break;
            }
            case HND_LANAYRU_TWILIGHT_INDEX: {
                loadFile("tpgzw/save_files/hundo/lanayru_twilight.bin");
                default_load();
                break;
            }
            case HND_BOSS_BUG_INDEX: {
                loadFile("tpgzw/save_files/hundo/boss_bug.bin");
                default_load();
                angle = 21504;
            ...
            case HND_KB_2_INDEX: {
                loadFile("tpgzw/save_files/hundo/kb2.bin");
                default_load();
            ...
            case HND_COROTD_INDEX: {
                loadFile("tpgzw/save_files/hundo/corotd.bin");
                default_load();
                angle = 27714;
            ...
            case HND_GM_INDEX: {
                loadFile("tpgzw/save_files/hundo/gm.bin");
                default_load();
                break;
            }
            case HND_DANGORO_INDEX: {
                loadFile("tpgzw/save_files/hundo/dangoro.bin");
                default_load();
                practice_file.inject_options_during_load = dangoro;
                break;
            }
            case HND_KB_1_INDEX: {
                loadFile("tpgzw/save_files/hundo/kb1.bin");
                default_load();
                break;
            }
            case HND_LAKEBED_BK_SKIP_INDEX: {
                loadFile("tpgzw/save_files/hundo/lakebed_bk_skip.bin");
                default_load();
            ...
            case HND_MORPHEEL_INDEX: {
                loadFile("tpgzw/save_files/hundo/morpheel.bin");
                default_load();
                practice_file.inject_options_after_load = morpheel;
                break;
            }
            case HND_STAR_1_INDEX: {
                loadFile("tpgzw/save_files/hundo/star_1.bin");
                default_load();
                break;
            }
            case HND_MDH_TOWER_INDEX: {
                loadFile("tpgzw/save_files/hundo/mdh_tower.bin");
                default_load();
            ...
            case HND_MDH_BRIDGE_INDEX: {
                loadFile("tpgzw/save_files/hundo/mdh_bridge.bin");
                default_load();
                break;
            }
            case HND_POST_MDH_INDEX: {
                loadFile("tpgzw/save_files/hundo/post_mdh.bin");
                default_load();
                break;
            }
            case HND_MOUNTAIN_INDEX: {
                loadFile("tpgzw/save_files/hundo/mountain.bin");
                default_load();
                break;
            }
            case HND_IZA_1_SKIP_INDEX: {
                loadFile("tpgzw/save_files/hundo/iza_1_skip.bin");
                default_load();
                practice_file.inject_options_during_load = iza_1_skip;
                break;
            }
            case HND_IZA_2_INDEX: {
                loadFile("tpgzw/save_files/hundo/iza_2.bin");
                default_load();
                break;
            }
            case HND_LH_CAVE_INDEX: {
                loadFile("tpgzw/save_files/hundo/lh_cave.bin");
                default_load();
                break;
            }
            case HND_BULBLIN_CAMP_INDEX: {
                loadFile("tpgzw/save_files/hundo/camp.bin");
                default_load();
                break;
            }
            case HND_AG_INDEX: {
                loadFile("tpgzw/save_files/hundo/ag.bin");
                default_load();
                break;
            }
            case HND_POE_1_SKIP_INDEX: {
                loadFile("tpgzw/save_files/hundo/poe_1_skip.bin");
                default_load();
            ...
            case HND_DSS_INDEX: {
                loadFile("tpgzw/save_files/hundo/death_sword_skip.bin");
                default_load();
                break;
            }
            case HND_STALLORD_INDEX: {
                loadFile("tpgzw/save_files/hundo/stallord.bin");
                default_load();
                practice_file.inject_options_during_load = stallord;
                break;
            }
            case HND_GORGE_INDEX: {
                loadFile("tpgzw/save_files/hundo/gorge_arc.bin");
                default_load();
                break;
            }
            case HND_SPR_INDEX: {
                loadFile("tpgzw/save_files/hundo/spr.bin");
                default_load();
                break;
            }
            case HND_DARK_HAMMER_INDEX: {
                loadFile("tpgzw/save_files/hundo/darkhammer.bin");
                default_load();
                //figure out how to disable armor sets then load in with boss flag for instant fight
                break;
            }
            case HND_SPR_SUPERJUMP_INDEX: {
                loadFile("tpgzw/save_files/hundo/spr_superjump.bin");
                default_load();
            ...
            case HND_SPR_BK_LJA_INDEX: {
                loadFile("tpgzw/save_files/hundo/spr_bk_lja.bin");
                default_load();
                angle = 32887;
            ...
            case HND_BLIZZETA_INDEX: {
                loadFile("tpgzw/save_files/hundo/blizzeta.bin");
                default_load();
                break;
            }
            case HND_BOMB_BOOST_INDEX: {
                loadFile("tpgzw/save_files/hundo/nf_bomb_boost.bin");
                default_load();
                break;
            }
            case HND_GROVE_2_INDEX: {
                loadFile("tpgzw/save_files/hundo/grove_2.bin");
                default_load();
                break;
            }
            case HND_TOT_INDEX: {
                loadFile("tpgzw/save_files/hundo/tot.bin");
                default_load();
                break;
            }
            case HND_EARLY_POE_INDEX: {
                loadFile("tpgzw/save_files/hundo/tot_early_poe.bin");
                default_load();
                practice_file.inject_options_during_load = tot_early_poe;
                break;
            }
            case HND_STATUE_THROWS_INDEX: {
                loadFile("tpgzw/save_files/hundo/tot_statue_throws.bin");
                default_load();
                break;
            }
            case HND_EARLY_HP_INDEX: {
                loadFile("tpgzw/save_files/hundo/tot_early_hp.bin");
                default_load();
                practice_file.inject_options_during_load = tot_early_hp;
                break;
            }
            case HND_DARKNUT_INDEX: {
                loadFile("tpgzw/save_files/hundo/tot_darknut.bin");
                default_load();
                break;
            }
            case HND_DOT_SKIP_INDEX: {
                loadFile("tpgzw/save_files/hundo/dot_skip.bin");
                default_load();
            ...
            case HND_ARMOGOHMA_INDEX: {
                loadFile("tpgzw/save_files/hundo/armogohma.bin");
                default_load();
                break;
            }
            case HND_POST_TOT_INDEX: {
                loadFile("tpgzw/save_files/hundo/post_tot.bin");
                default_load();
                break;
            }
            case HND_HOTSPRING_INDEX: {
                loadFile("tpgzw/save_files/hundo/hotspring.bin");
                default_load();
                break;
            }
            case HND_BELL_INDEX: {
                loadFile("tpgzw/save_files/hundo/silver_rupee.bin");
                default_load();
            ...
            case HND_FBF_INDEX: {
                loadFile("tpgzw/save_files/hundo/fbf.bin");
                default_load();
                break;
            }
            case HND_PUZZLE_INDEX: {
                loadFile("tpgzw/save_files/hundo/ice_puzzle.bin");
                default_load();
                break;
            }
            case HND_ARCHERY_INDEX: {
                loadFile("tpgzw/save_files/hundo/hv_archery.bin");
                default_load();
                angle = 64520;
            ...
            case HND_CITY_EARLY_INDEX: {
                loadFile("tpgzw/save_files/hundo/cits_early.bin");
                default_load();
                angle = 21207;
            ...
            case HND_CITY_1_INDEX: {
                loadFile("tpgzw/save_files/hundo/cits_1.bin");
                default_load();
            ...
            case HND_AERALFOS_INDEX: {
                loadFile("tpgzw/save_files/hundo/aeralfos_skip.bin");
                default_load();
                break;
            }
            case HND_CITY_2_INDEX: {
                loadFile("tpgzw/save_files/hundo/cits_2.bin");
                default_load();
                break;
            }
            case HND_POE_CYCLE_INDEX: {
                loadFile("tpgzw/save_files/hundo/cits_poe_cycle.bin");
                default_load();
                practice_file.inject_options_during_load = cits_poe_cycle;
                break;
            }
            case HND_FAN_TOWER_INDEX: {
                loadFile("tpgzw/save_files/hundo/fan_tower.bin");
                default_load();
                break;
            }
            case HND_ARGOROK_INDEX: {
                loadFile("tpgzw/save_files/hundo/argorok.bin");
                default_load();
                practice_file.inject_options_during_load = argorok;
                break;
            }
            case HND_STAR_2_INDEX: {
                loadFile("tpgzw/save_files/hundo/star_2.bin");
                default_load();
                break;
            }
            case HND_PALACE_1_INDEX: {
                loadFile("tpgzw/save_files/hundo/palace_1.bin");
                default_load();
                break;
            }
            case HND_PALACE_2_INDEX: {
                loadFile("tpgzw/save_files/hundo/palace_2.bin");
                default_load();
                practice_file.inject_options_after_load = palace2;
                break;
            }
            case HND_EARLY_PLATFORM_INDEX: {
                loadFile("tpgzw/save_files/hundo/early_platform.bin");
                default_load();
                break;
            }
            case HND_ZANT_INDEX: {
                loadFile("tpgzw/save_files/hundo/zant.bin");
                default_load();
                break;
            }
            case HND_COO_INDEX: {
                loadFile("tpgzw/save_files/hundo/coo.bin");
                default_load();
                practice_file.inject_options_during_load = cave_of_ordeals;
                break;
            }
            case HND_COO_10_INDEX: {
                loadFile("tpgzw/save_files/hundo/coo_10.bin");
                default_load();
                practice_file.inject_options_during_load = cave_of_ordeals;
                break;
            }
            case HND_COO_20_INDEX: {
                loadFile("tpgzw/save_files/hundo/coo_20.bin");
                default_load();
                practice_file.inject_options_during_load = cave_of_ordeals;
                break;
            }
            case HND_COO_30_INDEX: {
                loadFile("tpgzw/save_files/hundo/coo_30.bin");
                default_load();
                practice_file.inject_options_during_load = cave_of_ordeals;
                break;
            }
            case HND_CATS_INDEX: {
                loadFile("tpgzw/save_files/hundo/cats.bin");
                default_load();
            ...
            case HND_HYRULE_INDEX: {
                loadFile("tpgzw/save_files/hundo/hc.bin");
                default_load();
                break;
            }
            case HND_DARKNUT_SKIP_INDEX: {
                loadFile("tpgzw/save_files/hundo/hc_darknut.bin");
                default_load();
                break;
            }
            case HND_FINAL_TOWER_INDEX: {
                loadFile("tpgzw/save_files/hundo/hc_tower.bin");
                default_load();
                break;
            }
            case HND_BEAST_GANON_INDEX: {
                loadFile("tpgzw/save_files/hundo/beast_ganon.bin");
                default_load();
                break;
            }
            case HND_HORSEBACK_GANON_INDEX: {
                loadFile("tpgzw/save_files/hundo/horseback_ganon.bin");
                default_load();
                break;
            }
        }
